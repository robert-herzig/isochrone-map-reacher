...
// ── Transit isochrone is now handled client-side via MOTIS (europe.motis-project.de)
// This endpoint is no longer used.
app.post('/map-tool/api/transit-isochrone', async (req, res) => {
  return res.status(410).json({ error: 'Transit routing now handled client-side via MOTIS. This endpoint is deprecated.' });
});
